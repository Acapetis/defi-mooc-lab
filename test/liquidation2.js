...
describe("Liquidation with requirement from question 2", function () {
  // 2000 USDT 
  it("liquidate 2000 USDT", async function () {
    console.log(
      "\n\n----------- Begin -----------"
    );
  ...
  // 5000 USDT 
  it("liquidate 5000 USDT", async function () {
    console.log(
      "\n\n----------- Begin -----------"
    );
    await network.provider.request({
  ...
  // 10000 USDT 
  it("NOT liquidate 10000 USDT (transaction reverted)", async function () {
    console.log(
      "\n\n----------- Begin -----------"
    );
    await network.provider.request({
